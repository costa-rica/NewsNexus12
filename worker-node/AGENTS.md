...
- Emits `queryResults` for Google RSS request reporting. Rows with no AND/OR terms are `skipped / empty_query` and do not hit Google RSS; see `docs/20260519_google_rss_request_tracking_report_plan_V03.md`.
